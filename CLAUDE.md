...
- **ייחוס יום-קיץ (27 שעות, 6:00–19:00):** קיץ = השמש הכי גבוהה → צללים קצרים → הכי פחות צל → המבחן המחמיר ביותר לראוטר. **פערים ידועים:** (א) עונתיות השמש (הניווט נצמד למצב-השמש הקרוב) — *הבניינים הם שכבה קבועה, הפער בשמש לא בבניינים*; (ב) ריבוע 20מ' מצנטרואיד ולא קו-מתאר אמיתי.
